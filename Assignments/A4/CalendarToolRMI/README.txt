...
The Client directory contains the code for the CalendarTool client, the Server directory contains the code for the CalendarTool server and the class implementing the CalendarManager and Calendar service.

To compile the server, type 'javac CalendarToolServer.java' in the Server directory.

To compile the client, type 'javac CalendarToolClient.java' in the Client directory.
...
java -Djava.security.policy=policy.txt CalendarToolServer &

3) Run the client in the Client directory by typing:
java CalendarToolClient <Client_name>
